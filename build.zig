...
pub fn build(b: *std.Build) void {
    ...
    const infra_dep = b.dependency("infra", .{
        .target = target,
        .optimize = optimize,
    });
    const infra_mod = infra_dep.module("infra");
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "webidl" is the name you will use in your source code to
                // import this module (e.g. `@import("webidl")`). The name is
    ...
    const memory_stress = b.addExecutable(.{
        .name = "memory-stress",
        .root_module = b.createModule(.{
            .root_source_file = b.path("benchmarks/memory_stress_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "webidl", .module = mod },
